...
setValue(_rs.getDouble(_indexes.get(0).intValue()));
   ...
   * The method makes an real compare if the specified object is also an
   * instance of IntegerType, otherwise the default implementation from
   * {@link AbstractType#compareTo} is used.
   *
   * @param _locale   locale object
